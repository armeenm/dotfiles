# Generated by Powerlevel10k configuration wizard on 2021-09-22 at 20:52 CDT.
  ...
  #     '~/work(|/*)'  WORK     ''
    ...
    [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${meta}@${clean}${VCS_STATUS_COMMIT[1,8]}"
        ...
        if [
        [
          -n ${VCS_STATUS_REMOTE_BRANCH: #$VCS_STATUS_LOCAL_BRANCH} ]]; then
    ...
    if [[ $VCS_STATUS_COMMIT_SUMMARY == (|*[^[:alnum:]])(wip|WIP)(|[^[:alnum:]]*) ]]; then
      res+=" ${modified}wip"
          ...
          typeset -g
          POWERLEVEL9K_VCS_
          { STAGED, UNSTAGED, UNTRACKED, CONFLICTED, COMMITS_AHEAD, COMMITS_BEHIND }_MAX_NUM=-1
          ...
          typeset -g
          POWERLEVEL9K_CONTEXT_
          { REMOTE, REMOTE_SUDO }_FOREGROUND=180
          ...
          typeset -g
          POWERLEVEL9K_NODEENV_
          { LEFT, RIGHT }_DELIMITER=
          # Custom icon.
          ...
          typeset - g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(. * tun)|tailscale) * '
          ...
          typeset - g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_RX_RATE:+ %70 F < $P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215 F > $P9K_IP_TX_RATE}'
