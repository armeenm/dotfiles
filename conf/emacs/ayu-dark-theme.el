(deftheme ayu-dark "Port of the Ayu dark theme.")
...
(custom-theme-set-faces
  ...
  '(match (
           (((class color) (min-colors 88) (background light)) (:background "white"))
           (((class color) (min-colors 88) (background dark)) (:background "black"))
           (((class color) (min-colors 8) (background light)) (:foreground "black" :background "white"))
           (((class color) (min-colors 8) (background dark)) (:foreground "white" :background "black"))
